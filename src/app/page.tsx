    ...
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="flex-1">
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6 mx-auto">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-12 text-gray-900 dark:text-white">Überblick über die Funktionen</h2>
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              {[
                ...
                { icon: Clock, title: "Automatisierung", description: "Reduzieren Sie den Planungsaufwand erheblich durch automatisierte Prozesse." },
